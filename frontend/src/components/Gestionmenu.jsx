...
import { getIngredientes, updateIngrediente } from "../services/ingrediente.service"; // Agregamos este servicio
...
const handleImageChange = (e) => {
  ...
  const handleEdit = async (plato) => {
    setingredientesCheck([]);
    setEditPlato(plato);
    console.log("plato:",plato);
    console.log("plato.platoID:",plato.platoID);
    ...
    await updatePlato(plato.platoID, newPlato)
